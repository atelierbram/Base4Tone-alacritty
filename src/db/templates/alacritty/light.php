...
echo "\n";
echo "# Colors $scheme-Light\n";
echo "# by $author; on $url_project; \n";
echo "colors:\n";
echo "  # Default colors\n";
echo "  primary:\n";
echo "    background: '0x$B4T_b23'\n";
echo "    foreground: '0x$B4T_b9'\n";
echo "\n";
...
echo "    red:     '0x$B4T_D12'\n";
echo "    green:   '0x$B4T_B7'\n";
echo "    yellow:  '0x$B4T_A8'\n";
echo "    blue:    '0x$B4T_B9'\n";
echo "    magenta: '0x$B4T_C9'\n";
echo "    cyan:    '0x$B4T_A11'\n";
echo "    white:   '0x$B4T_a11'\n";
echo "\n";
echo "  # Bright colors\n";
echo "  #bright:\n";
echo "  #  black:   '0x666666'\n";
...
echo "window.dynamic_title: true\n";
echo "\n";
echo "cursor:\n";
echo "  # Cursor style\n";
echo "  #\n";
